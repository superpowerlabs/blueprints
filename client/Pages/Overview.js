...
1. **Appearance**: defines how characters look in-game

2. **Statistics**: define a character’s basic in-game capabilities and their rarity

3. **Abilities**: define special modifiers that can affect combat, buildings, and other gameplay elements.
      ...
      >
        <Row>
          ...
          <Col md={"8"} className={"doc"}>
            ...
            >
              <Markdown source={text[0]} />
              <div className={"centered padded"}>
                <img src={"/images/black_avatar.gif"} />
              </div>
              <Markdown source={text[1]} />
              <div className={"centered padded"}>
                <img src={"/images/black_color_avatar.gif"} />
              </div>
              <Markdown source={text[2]} />
              <div className={"centered padded"}>
                <img src={"/images/color_avatar.gif"} />
              </div>
              <Markdown source={text[3]} />
            </div>
          </Col>
        </Row>
      </Container>
